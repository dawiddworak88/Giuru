namespace Foundation.Pricing.Definitions
{
    public struct PriceDriversConstants
    {
        ...
        // product/stock outlet-availability. Omitting it, or deriving it from stock state, makes
        // the catalog and the basket quote the same line at different prices.
