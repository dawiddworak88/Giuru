...
{
    class InventoryApiImage : IImage
    {
        private readonly SemaphoreSlim _semaphoreSlim = new SemaphoreSlim(1, 1);

        private readonly IImage _image = new DockerImage("testcontainers", "inventory-api", DateTimeOffset.UtcNow.ToUnixTimeSeconds().ToString());
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
                await new ImageFromDockerfileBuilder()
                    ...
                    .WithDockerfile("Project/Services/Inventory/Inventory.Api/Dockerfile")
