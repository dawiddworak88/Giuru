...
{
    public class CatalogApiImage : IImage
    {
        private readonly SemaphoreSlim _semaphoreSlim = new SemaphoreSlim(1, 1);

        private readonly IImage _image = new DockerImage("testcontainers", "catalog-api", DateTimeOffset.UtcNow.ToUnixTimeSeconds().ToString());
        ...
        public async Task InitializeAsync()
        {
            ...
            try
            {
                await new ImageFromDockerfileBuilder()
                    ...
                    .WithDockerfile("Project/Services/Catalog/Catalog.Api/Dockerfile")
