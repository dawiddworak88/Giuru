...
{
    public class UpdateDownloadCenterFileModelValidator : BaseServiceModelValidator<UpdateDownloadCenterFileServiceModel>
    {
        public UpdateDownloadCenterFileModelValidator()
        {
