    ...
    public static class ApprovalsSeed
    {
        public static void SeedApprovals(IdentityContext context)
        {
            SeedApproval(
                ...
                "I consent to receiving commercial information from ELTAP via electronic means, to the email address I have provided",
                "Wyrażam zgodę na otrzymywanie informacji handlowych od ELTAP drogą elektroniczną, na wskazany przeze mnie adres e-mail",
                "Ich stimme zu, kommerzielle Informationen von ELTAP auf elektronischem Wege an die von mir angegebene E-Mail-Adresse zu erhalten");

            SeedApproval(
                context,
                Guid.Parse("d34ec3d3-bb88-4de5-9391-d9d29609551a"),
                "I consent to being contacted by phone by ELTAP for marketing purposes",
                "Wyrażam zgodę na kontakt telefoniczny ze strony ELTAP w celach marketingowych",
                "Ich stimme einem telefonischen Kontakt durch ELTAP zu Marketingzwecken zu");
        }
