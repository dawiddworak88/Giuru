...
{
    public class ClientTeamMemberService : IClientTeamMemberService
    {
        ...
        public ClientTeamMemberService(
        ...
        public async Task<Guid> CreateAsync(CreateClientTeamMemberServiceModel model)
        {
        ...
        public async Task<ClientTeamMemberServiceModel> GetAsync(GetClientTeamMemberServiceModel model)
        {
            ...
            var teamMember = new ClientTeamMemberServiceModel
            {
                Id = model.Id,
