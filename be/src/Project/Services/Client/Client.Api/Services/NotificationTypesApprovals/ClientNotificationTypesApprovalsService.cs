...
{
    public class ClientNotificationTypesApprovalsService : IClientNotificationTypesApprovalsService
    {
        private readonly ClientContext _context;

        public ClientNotificationTypesApprovalsService(ClientContext context)
        {
            _context = context;
        }

        public IEnumerable<ClientNotificationTypeApprovalServiceModel> Get(GetClientNotificationTypesApprovalsServiceModel model)
        {
        ...
        public async Task SaveAsync(SaveNotificationTypesApprovalsServiceModel model)
        {
