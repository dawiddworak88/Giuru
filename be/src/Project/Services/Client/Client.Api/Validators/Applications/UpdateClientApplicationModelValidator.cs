...
{
    public class UpdateClientApplicationModelValidator : BaseServiceModelValidator<UpdateClientApplicationServiceModel>
    {
        public UpdateClientApplicationModelValidator()
        {
