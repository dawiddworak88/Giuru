...
using Download.Api.v1.Categories.ResponseModel;
using Download.Api.Validators.Downloads;
...
namespace Download.Api.v1.Categories.Controllers
{
    [ApiVersion("1.0")]
    ...
    public class DownloadsController : BaseApiController
    {
        ...
        public async Task<IActionResult> Get(string searchTerm, int pageIndex, int itemsPerPage, string orderBy)
        {
            ...
            var serviceModel = new GetDownloadsServiceModel
            {
            ...
            var validator = new GetDownloadsModelValidator();
            var validationResult = await validator.ValidateAsync(serviceModel);
