...
using Download.Api.DependencyInjection;
...
builder.Services.RegisterDownloadApiDependencies();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Download API", Version = "v1" });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Download API");
