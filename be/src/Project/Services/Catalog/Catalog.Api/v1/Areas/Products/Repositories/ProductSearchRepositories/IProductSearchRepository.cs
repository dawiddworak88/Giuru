...
namespace Catalog.Api.v1.Areas.Products.Repositories.ProductSearchRepositories
{
    ...
    {
        Task<PagedResults<IEnumerable<ProductSearchModel>>> GetAsync(string language, Guid? categoryId, Guid? sellerId, bool includeProductVariants, string searchTerm, int pageIndex, int itemsPerPage);
