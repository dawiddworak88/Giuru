...
{
    public class ProductPageModelBuilder : IAsyncComponentModelBuilder<PriceComponentModel, ProductPageViewModel>
    {
        ...
        private readonly IAsyncComponentModelBuilder<PriceComponentModel, ProductDetailViewModel> _productDetailModelBuilder;
        ...
        public ProductPageModelBuilder(
            ...
            IAsyncComponentModelBuilder<PriceComponentModel, ProductDetailViewModel> productDetailModelBuilder,
        ...
        public async Task<ProductPageViewModel> BuildModelAsync(PriceComponentModel componentModel)
        {
