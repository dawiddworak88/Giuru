...
namespace Seller.Web.Shared.Repositories.Clients
{
    public interface IClientsRepository
    {
        ...
        Task<Guid> SaveAsync(string token, string language, Guid? id, string name, string email, string communicationLanguage, string phoneNumber, Guid organisationId, IEnumerable<Guid> clientGroupIds, Guid? clientManager);
