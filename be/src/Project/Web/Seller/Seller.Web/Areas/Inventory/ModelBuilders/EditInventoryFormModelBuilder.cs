...
{
    public class EditInventoryFormModelBuilder : IAsyncComponentModelBuilder<ComponentModelBase, EditInventoryFormViewModel>
    {
        ...
        public EditInventoryFormModelBuilder(
        ...
        public async Task<EditInventoryFormViewModel> BuildModelAsync(ComponentModelBase componentModel)
        {
