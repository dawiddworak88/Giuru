...
{
    public class EditWarehouseFormModelBuilder : IAsyncComponentModelBuilder<ComponentModelBase, EditWarehouseFormViewModel>
    {
        ...
        public EditWarehouseFormModelBuilder(
        ...
        public async Task<EditWarehouseFormViewModel> BuildModelAsync(ComponentModelBase componentModel)
        {
            var viewModel = new EditWarehouseFormViewModel
            {
