...
{
    public class ClientNotificationTypesApprovalsRepository : IClientNotificationTypesApprovalsRepository
    {
        private readonly IApiClientService _apiClientService;
        private readonly IOptions<AppSettings> _settings;

        public ClientNotificationTypesApprovalsRepository(
        ...
        {
            var requestModel = new ClientNotificationTypesApprovalsRequestModel
            {
                ClientId = clientId,
                NotificationTypeIds = notificationTypeIds
            };

            var apiRequest = new ApiRequest<ClientNotificationTypesApprovalsRequestModel>
            {
                AccessToken = token,
                Language = language,
                Data = requestModel,
            ...
            var response = await _apiClientService.PostAsync<ApiRequest<ClientNotificationTypesApprovalsRequestModel>, ClientNotificationTypesApprovalsRequestModel, BaseResponseModel>(apiRequest);
