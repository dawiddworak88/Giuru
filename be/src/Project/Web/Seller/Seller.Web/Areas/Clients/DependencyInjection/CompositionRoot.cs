...
namespace Seller.Web.Areas.Clients.DependencyInjection
{
    public static class CompositionRoot
    {
        public static void RegisterClientsAreaDependencies(this IServiceCollection services)
        {
            ...
            services.AddScoped<IClientApprovalsRepository, ClientApprovalsRepository>();
            ...
            services.AddScoped<IAsyncComponentModelBuilder<ComponentModelBase, ClientApprovalsPageViewModel>, ClientApprovalsPageModelBuilder>();
            services.AddScoped<IAsyncComponentModelBuilder<ComponentModelBase, CatalogViewModel<ClientApproval>>, ClientApprovalsPageCatalogModelBuilder>();
            services.AddScoped<IAsyncComponentModelBuilder<ComponentModelBase, ClientApprovalFormViewModel>, ClientApprovalFormModelBuilder>();
            services.AddScoped<IAsyncComponentModelBuilder<ComponentModelBase, ClientApprovalPageViewModel>, ClientApprovalPageModelBuilder>();
        }
    }
}