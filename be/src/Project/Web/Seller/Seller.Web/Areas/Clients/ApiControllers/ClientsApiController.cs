...
namespace Seller.Web.Areas.Clients.ApiControllers
{
    ...
    public class ClientsApiController : BaseApiController
    {
        ...
        public async Task<IActionResult> Index([FromBody] SaveClientRequestModel model)
        {
            ...
            var clientId = await this.clientsRepository.SaveAsync(token, language, model.Id, model.Name, model.Email, model.CommunicationLanguage, model.CountryId, model.PhoneNumber, organisationId.Value, model.ClientGroupIds, model.ClientManagerIds, model.DefaultDeliveryAddressId);
