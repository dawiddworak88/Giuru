...
namespace Seller.Web.Areas.Clients.ModelBuilders
{
    public class ClientsPageCatalogModelBuilder : IAsyncComponentModelBuilder<ComponentModelBase, CatalogViewModel<Client>>
    {
        ...
        public async Task<CatalogViewModel<Client>> BuildModelAsync(ComponentModelBase componentModel)
        {
            ...
            viewModel.PagedItems = await this.clientsRepository.GetClientsAsync(componentModel.Token, componentModel.Language, null, componentModel.SellerId, Foundation.GenericRepository.Definitions.Constants.DefaultPageIndex, Foundation.GenericRepository.Definitions.Constants.DefaultItemsPerPage);
