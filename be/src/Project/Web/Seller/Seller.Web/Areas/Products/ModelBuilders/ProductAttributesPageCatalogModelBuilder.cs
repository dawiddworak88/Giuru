...
namespace Seller.Web.Areas.Products.ModelBuilders
{
    public class ProductAttributesPageCatalogModelBuilder : IAsyncComponentModelBuilder<ComponentModelBase, CatalogViewModel<ProductAttribute>>
    {
        ...
        public async Task<CatalogViewModel<ProductAttribute>> BuildModelAsync(ComponentModelBase componentModel)
        {
            ...
            viewModel.PagedItems = await this.productAttributesRepository.GetProductAttributesAsync(componentModel.Token, componentModel.Language, null, componentModel.SellerId, Foundation.GenericRepository.Definitions.Constants.DefaultPageIndex, Foundation.GenericRepository.Definitions.Constants.DefaultItemsPerPage, $"{nameof(ProductAttribute.CreatedDate)} desc");
