...
namespace Seller.Web.Areas.Products.Repositories
{
    ...
    {
        Task<Guid> SaveAsync(string token, string language, Guid? id, Guid? parentCategoryId, string name, IEnumerable<Guid> files, string schema, string uiSchema, int order);
