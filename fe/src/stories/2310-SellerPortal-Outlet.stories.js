...
export const OutletPageStory = () => <OutletPage header={header} menuTiles={menuTiles} footer={footer} catalog={catalog} />;

OutletPageStory.story = {
  name: "Outlet Page",
};

const SellerOutletStories = {
  title: "SellerPortal.Outlet",
  component: OutletPageStory,
};

export default SellerOutletStories;
