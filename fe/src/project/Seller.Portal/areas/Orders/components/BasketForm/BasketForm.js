...
import BasketConstants from "../../../../../../shared/constants/BasketConstants";
...
function BasketForm(props) {
    ...
    const onSuggestionsFetchRequested = (args) => {
        ...
        if (args.value && args.value.length >= BasketConstants.minSuggestionSearchTermLength()) {

            const searchParameters = {
                searchTerm: args.value,
                pageIndex: 1,
                hasPrimaryProduct: true,
                itemsPerPage: BasketConstants.productSuggestionsNumber()
            };
