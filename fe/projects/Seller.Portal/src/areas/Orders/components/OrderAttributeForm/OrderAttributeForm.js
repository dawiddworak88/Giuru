...
const OrderAttributeForm = (props) => {
                ...
                <div className="column is-half">
                    <form className="is-modern-form" onSubmit={handleOnSubmit}>
                        ...
                        <div className="field">
                            ...
                            <a href={props.orderAttributesUrl} className="ml-2 button is-text">{props.navigateToAttributesText}</a>
                        </div>
                    </form>
                </div>
            </div>
...
OrderAttributeForm.propTypes = {
    title: PropTypes.string.isRequired,
    idLabel: PropTypes.string.isRequired,
    nameLabel: PropTypes.string.isRequired,
    typeLabel: PropTypes.string.isRequired, 
    orderAttributesUrl: PropTypes.string.isRequired,
    navigateToAttributesText: PropTypes.string.isRequired,
