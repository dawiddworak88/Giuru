...
const browserConfig = {
    ...
    entry: {
        ...
        basketpage: ["./src/project/AspNetCore/areas/Orders/pages/BasketPage/index.js", "./src/project/AspNetCore/areas/Orders/pages/BasketPage/BasketPage.scss"],
        orderspage: ["./src/project/AspNetCore/areas/Orders/pages/OrdersPage/index.js", "./src/project/AspNetCore/areas/Orders/pages/OrdersPage/OrdersPage.scss"],
        orderpage: ["./src/project/AspNetCore/areas/Orders/pages/OrderPage/index.js", "./src/project/AspNetCore/areas/Orders/pages/OrderPage/OrderPage.scss"],
...
const sellerPortalBrowserConfig = {
    ...
    entry: {
        ...
        basketpage: ["./src/project/Seller.Portal/areas/Orders/pages/BasketPage/index.js", "./src/project/Seller.Portal/areas/Orders/pages/BasketPage/BasketPage.scss"],
