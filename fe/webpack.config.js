...
var sellerPortalBrowserConfig = {
    ...
    entry: {
        newoutletpage: ["./src/project/Seller.Portal/areas/Outlet/pages/NewOutletPage/index.js", "./src/project/Seller.Portal/areas/Outlet/pages/NewOutletPage/NewOutletPage.scss"],
        outletpage: ["./src/project/Seller.Portal/areas/Outlet/pages/OutletPage/index.js", "./src/project/Seller.Portal/areas/Outlet/pages/OutletPage/OutletPage.scss"],
